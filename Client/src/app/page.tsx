...
export default function Home() {
  return (
    <div className='relative z-0 px-16 py-20 bg-[#1E1E1E]'>
      ...
      <Image className='absolute z-20 left-0 top-10 w-96' src={soldierImg} alt='' width={545} height={685} />
        ...
        <div className='pl-96 pb-20 bg-[#111111]'>
          <header className='flex items-start justify-between mb-16'>
            ...
            <div className='flex gap-6 mt-4 mr-4'>
              <input type="text" name="browse" id="browse" className='z-10 px-3 py-2 text-[#B1B1B1] bg-[#666666]' placeholder='Browser Chronicles...' />
          ...
          <div className='flex gap-20'>
            <div className='w-[560px]'>
              ...
              <h3 className='text-md max-w-xs mb-8'>A revolutionary gaming experience where your weapon isn&apos;t just a tool but a living entity that evolves alongside you. Immerse yourself in a dynamic world filled with challenges, battles, and untold secrets, as you embark on a quest to forge the ultimate armament.</h3>
              <div className='w-56'>
                <ButtonLP onClick="/dapp">
                  Go to dapp
                </ButtonLP>
              </div>
            </div>
            <div className='items-end'>
              <Image src={rightLp} alt='' width={400} height={400} className='w-96'/>
            </div>
          </div>
        </div>
        ...
        <div className='flex items-center'>
          <div className='w-1/2 bg-[#111111] my-20 mx-10 flex'>
            <div className='p-12 w-1/2'>
              ...
              <p className='text-md mb-8'>Through relentless battles and strategic decision-making, you can unlock an unprecedented system of weapon evolution.</p>
              <ButtonLP onClick="">
                Explore
              </ButtonLP>
            </div>
          ...
          <div className='flex'>
            <div>
              <Image src={PlayerLp} alt='' width={270} height={350} className='w-60' />
            </div>
            <div className='ml-6 pr-6 flex items-center flex-col justify-center gap-8 border-y-2 border-r-2 border-white '>
              <div className='flex items-center gap-4'>
                <span>Power</span>
                <Image src={GroupPower} alt='' width={270} height={350} className='w-48' />
              </div>
              <div className='flex items-center gap-4'>
                <span>Visitors</span>
                <Image src={GroupVisitors} alt='' width={270} height={350} className='w-48' />
              </div>
              <div className='flex items-center gap-4'>
                <span>Market</span>
                <Image src={GroupMarket} alt='' width={270} height={350} className='w-48' />
              </div>
            </div>
          </div>
        </div>
